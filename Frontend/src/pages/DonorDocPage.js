...
const DonorDocPage = () => {
    ...
    useEffect(() => {
        fetch('http://localhost:8080/donors/documents')
    ...
    const columns = [
        ...
        { title: 'Business Registration Detail', dataIndex: 'businessRegistrationDetail', key: 'businessRegistrationDetail' }
    ];
